...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='initiativeresourceitemplan',
            name='organization',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invitations', to='management_project.organizationalprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Stakeholder',
